...
namespace CoinPouch.Data {
    public enum Currency {
        ...
        [Name("Storm Seal"), ID(20), Maximum(80000), DefaultThreshold(80000), Category("Common"), Vendors(Vendor.StormQuartermaster)]
        StormSeal,
        [Name("Serpent Seal"), ID(21), Maximum(80000), DefaultThreshold(80000), Category("Common"), Vendors(Vendor.SerpentQuartermaster)]
        SerpentSeal,
        [Name("Flame Seal"), ID(22), Maximum(80000), DefaultThreshold(80000), Category("Common"), Vendors(Vendor.FlameQuartermaster)]
        FlameSeal,
